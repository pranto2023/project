! function (d) {
    ...
    a.DEFAULTS = {
        ...
        this.$displayAllBtn && this.$displayAllBtn.toggleClass("btn-primary", t), this.$table.toggleClass("display-all", t), this.$tableClone && this.$tableClone.toggleClass("display-all", t), i && d(window).trigger(this.displayAllTrigger)
        ...
        if (t = this.options.mainContainer === window ? o < a && a < o + i.$table.height() : o <= 0 && -o < i.$table.height(), i.useFixedSolution) {
            if (i.$stickyTableHeader.scrollLeft(i.$tableScrollWrapper.scrollLeft()), e = l - 1, this.options.mainContainer === window && s < a - o ? (e -= a - o - s, i.$stickyTableHeader.addClass("border-radius-fix")) : this.options.mainContainer !== window && s < -o ? (e -= -o - s, i.$stickyTableHeader.addClass("border-radius-fix")) : i.$stickyTableHeader.removeClass("border-radius-fix"), t) return void i.$stickyTableHeader.css({
                visibility: "visible",
                top: e + "px",
                width: i.$tableScrollWrapper.innerWidth() + "px"
            });
            i.$stickyTableHeader.css({
                visibility: "hidden",
                width: "auto"
            })
        } else {
            (e = this.options.mainContainer === window ? a - o - 1 : -o - 1) < 0 ? e = 0 : s < e && (e = s), this.options.mainContainer === window && 0 < n && (e -= n), t ? (i.$stickyTableHeader.css({
                visibility: "visible"
            }), i.$stickyTableHeader.animate({
                top: e + "px"
            }, 400), i.$thead.css({
                visibility: "hidden"
            })) : i.$stickyTableHeader.animate({
        ...
        n.$hdrCells.each(function (t) {
            ...
            if (e || (e = n.idPrefix + t, i.prop("id", e)), "" === o && (o = i.attr("data-col-name")), i.is("[data-priority]") && -1 !== i.data("priority")) {
                var a = d('<li class="checkbox-row"><input type="checkbox" name="toggle-' + e + '" id="toggle-' + e + '" value="' + e + '" /> <label for="toggle-' + e + '">' + o + "</label></li>"),
                    s = a.find("input");
                n.$dropdownContainer.append(a), a.click(function () {
                    ...
                    t.stopPropagation()
                }), a.find("input").click(function (t) {
                    t.stopPropagation()
                }).change(function () {
                    var e = d(this),
                        t = e.val(),
                        i = n.$tableWrapper.find("#" + t + ", #" + t + "-clone, [data-columns~=" + t + "]");
                    n.$table.hasClass("display-all") && (d.proxy(n.preserveDisplayAll(), n), n.$table.removeClass("display-all"), n.$tableClone && n.$tableClone.removeClass("display-all"), n.$displayAllBtn.removeClass("btn-primary")), i.each(function () {
                        var t = d(this);
                        if (e.is(":checked")) {
        ...
        var l = 0,
            r = 0;
        if (this.$thead.find("tr").first().find("th").each(function (t) {
            for (var i = d(this), e = i.prop("colSpan"), o = i.prop("rowSpan"), a = 0; a < e; a++) s.headerColIndices[l + t + a] = t, 0 <= l + t + a && (n[l + t + a - r] = r);
            1 < o && r++ , l += e - 1
        }), 2 < this.$thead.find("tr").length) throw new Error("This plugin doesnt support more than two rows in thead.");
        2 === this.$thead.find("tr").length && d(this.$thead.find("tr")[1]).find("th").each(function (t) {
        ...
        t.find("[id]").each(function () {
            d(this).prop("id", d(this).prop("id") + "-clone")
        }), t.appendTo(this.$tableClone), this.$dropdownContainer.find("input").trigger("change")
